...
parser.add_argument("--sampledist", "-s", type=int, default=1)
...
if print_interval == 0:
    ...
    exit()
sampledistance = args.sampledist
if sampledistance < 0:
    print "Please specify a valid sampling distance (positive integer)"
    exit()
